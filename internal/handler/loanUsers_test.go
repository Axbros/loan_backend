...
func newLoanUsersHandler() *gotest.Handler {
	...
	d.IDao = dao.NewLoanUsersDao(d.DB, c.ICache.(cache.LoanUsersCache))

	// init mock handler
	h := gotest.NewHandler(d, testData)
	h.IHandler = &loanUsersHandler{iDao: d.IDao.(dao.LoanUsersDao)}
	iHandler := h.IHandler.(LoanUsersHandler)
...
func Test_loanUsersHandler_Create(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := &types.CreateLoanUsersRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanUsers))
...
func Test_loanUsersHandler_DeleteByID(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
...
func Test_loanUsersHandler_UpdateByID(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := &types.UpdateLoanUsersByIDRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanUsers))
...
func Test_loanUsersHandler_GetByID(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
...
func Test_loanUsersHandler_List(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("List"), &types.ListLoanUserssRequest{query.Params{
		Page:  0,
		Limit: 10,
...
func Test_loanUsersHandler_DeleteByIDs(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanUserssByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanUserssByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanUsersHandler_GetByCondition(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("GetByCondition"), &types.GetLoanUsersByConditionRequest{
		query.Conditions{
...
func Test_loanUsersHandler_ListByIDs(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanUserssByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanUserssByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanUsersHandler_ListByLastID(t *testing.T) {
	h := newLoanUsersHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanUsers)
...
func TestNewLoanUsersHandler(t *testing.T) {
	defer func() {
		recover()
	}()
	_ = NewLoanUsersHandler()
}
