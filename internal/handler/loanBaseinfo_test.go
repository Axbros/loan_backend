...
func newLoanBaseinfoHandler() *gotest.Handler {
	...
	d.IDao = dao.NewLoanBaseinfoDao(d.DB, c.ICache.(cache.LoanBaseinfoCache))

	// init mock handler
	h := gotest.NewHandler(d, testData)
	h.IHandler = &loanBaseinfoHandler{iDao: d.IDao.(dao.LoanBaseinfoDao)}
	iHandler := h.IHandler.(LoanBaseinfoHandler)
...
func Test_loanBaseinfoHandler_Create(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := &types.CreateLoanBaseinfoRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanBaseinfo))
...
func Test_loanBaseinfoHandler_DeleteByID(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
...
func Test_loanBaseinfoHandler_UpdateByID(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := &types.UpdateLoanBaseinfoByIDRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanBaseinfo))
...
func Test_loanBaseinfoHandler_GetByID(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
...
func Test_loanBaseinfoHandler_List(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("List"), &types.ListLoanBaseinfosRequest{query.Params{
		Page:  0,
		Limit: 10,
...
func Test_loanBaseinfoHandler_DeleteByIDs(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanBaseinfosByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanBaseinfosByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanBaseinfoHandler_GetByCondition(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("GetByCondition"), &types.GetLoanBaseinfoByConditionRequest{
		query.Conditions{
...
func Test_loanBaseinfoHandler_ListByIDs(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanBaseinfosByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanBaseinfosByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanBaseinfoHandler_ListByLastID(t *testing.T) {
	h := newLoanBaseinfoHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanBaseinfo)
...
func TestNewLoanBaseinfoHandler(t *testing.T) {
	defer func() {
		recover()
	}()
	_ = NewLoanBaseinfoHandler()
}
