...
func newLoanRolesHandler() *gotest.Handler {
	...
	d.IDao = dao.NewLoanRolesDao(d.DB, c.ICache.(cache.LoanRolesCache))

	// init mock handler
	h := gotest.NewHandler(d, testData)
	h.IHandler = &loanRolesHandler{iDao: d.IDao.(dao.LoanRolesDao)}
	iHandler := h.IHandler.(LoanRolesHandler)
...
func Test_loanRolesHandler_Create(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := &types.CreateLoanRolesRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanRoles))
...
func Test_loanRolesHandler_DeleteByID(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
...
func Test_loanRolesHandler_UpdateByID(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := &types.UpdateLoanRolesByIDRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.LoanRoles))
...
func Test_loanRolesHandler_GetByID(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
...
func Test_loanRolesHandler_List(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("List"), &types.ListLoanRolessRequest{query.Params{
		Page:  0,
		Limit: 10,
...
func Test_loanRolesHandler_DeleteByIDs(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanRolessByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteLoanRolessByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanRolesHandler_GetByCondition(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("GetByCondition"), &types.GetLoanRolesByConditionRequest{
		query.Conditions{
...
func Test_loanRolesHandler_ListByIDs(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
	...
	result := &httpcli.StdResult{}
	err := httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanRolessByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = httpcli.Post(result, h.GetRequestURL("ListByIDs"), &types.ListLoanRolessByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_loanRolesHandler_ListByLastID(t *testing.T) {
	h := newLoanRolesHandler()
	defer h.Close()
	testData := h.TestData.(*model.LoanRoles)
...
func TestNewLoanRolesHandler(t *testing.T) {
	defer func() {
		recover()
	}()
	_ = NewLoanRolesHandler()
}
