...
func loanReferralVisitsRouter(group *gin.RouterGroup, h handler.LoanReferralVisitsHandler) {
	...
	g.POST("/", h.Create)          // [post] /api/v1/loanReferralVisits
	g.DELETE("/:id", h.DeleteByID) // [delete] /api/v1/loanReferralVisits/:id
	g.PUT("/:id", h.UpdateByID)    // [put] /api/v1/loanReferralVisits/:id
