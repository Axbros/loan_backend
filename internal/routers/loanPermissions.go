...
func loanPermissionsRouter(group *gin.RouterGroup, h handler.LoanPermissionsHandler) {
	...
	g.POST("/", h.Create)          // [post] /api/v1/loanPermissions
	g.DELETE("/:id", h.DeleteByID) // [delete] /api/v1/loanPermissions/:id
	...
	g.GET("/list", h.ListByLastID)         // [get] /api/v1/loanPermissions/list
}
