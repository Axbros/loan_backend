...
func loanCollectionCasesRouter(group *gin.RouterGroup, h handler.LoanCollectionCasesHandler) {
	...
	g.POST("/", h.Create)          // [post] /api/v1/loanCollectionCases
	g.DELETE("/:id", h.DeleteByID) // [delete] /api/v1/loanCollectionCases/:id
	...
	g.GET("/list", h.ListByLastID)         // [get] /api/v1/loanCollectionCases/list
}
