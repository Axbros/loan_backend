...
type LoanDepartmentRoles struct {
	...
	DepartmentID uint64 `gorm:"column:department_id;type:bigint(20);primary_key" json:"departmentID"`
	RoleID       uint64 `gorm:"column:role_id;type:bigint(20);not null" json:"roleID"`
}
