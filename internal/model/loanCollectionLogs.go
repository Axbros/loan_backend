...
type LoanCollectionLogs struct {
	...
	CaseID          uint64     `gorm:"column:case_id;type:bigint(20);not null" json:"caseID"`                    // 关联催收任务 loan_collection_cases.id
	...
	NextFollowUpAt  *time.Time `gorm:"column:next_follow_up_at;type:datetime" json:"nextFollowUpAt" copier:"-"`  // 下次跟进时间(可选)
}
