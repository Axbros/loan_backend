...
var (
	...
	ErrUnsupportedFileTypeBaseinfo = errcode.NewError(loanBaseinfoBaseCode+10, "unsupported file type")
	ErrCreateFileFolderBaseinfo    = errcode.NewError(loanBaseinfoBaseCode+11, "创建文件目录失败！")
	ErrInvalidFilePathBaseinfo     = errcode.NewError(loanBaseinfoBaseCode+12, "创建本地文件失败")
	ErrSaveFileBaseinfo            = errcode.NewError(loanBaseinfoBaseCode+13, "保存文件失败")
	ErrFileNotFoundBaseinfo        = errcode.NewError(loanBaseinfoBaseCode+14, "file not found")
	ErrReadFileBaseinfo            = errcode.NewError(loanBaseinfoBaseCode+15, "failed to read the file")
